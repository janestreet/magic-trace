...
let%expect_test "A raise_notrace OCaml exception" =
  ...
  [%expect
    {|
    23860/23860 426567.068172167:                                branches:uH:   call                           411021 camlRaise_test__entry+0x71 (foo.so) =>           410f70 camlRaise_test__raise_after_265+0x0 (foo.so)
    ...
    23860/23860 426567.068172190:                                branches:uH:   jmp                            410fa0 camlRaise_test__raise_after_265+0x30 (foo.so) =>           411030 camlRaise_test__entry+0x80 (foo.so)
